...
const Hotel = () => {
  ...
  const diffTime = dates[0].endDate - dates[0].startDate;
  const diffDays = diffTime / MILLISECONDS_PER_DAYS;
  const days = diffDays;
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelDetails">
            ...
            <div className="hotelDetailsPrice">
              ...
              <span>
                Located a few steps from Pasut Beach, Beach walk villa Pryaniki
              </span>
              <h2>
